...
export const Demo1Layout: React.FC<Demo1LayoutProps> = ({
  ...
  return (
    <div className="min-h-screen bg-[#fdfbf7] text-neutral-900 font-d1-body selection:bg-amber-200 flex flex-col">
      ...
      {/* Top Academic Institutional Band */}
      <div className="border-b border-neutral-800 bg-[#0d1b2a] text-neutral-300 text-xs px-4 py-2 font-d1-meta">
        <div className="mx-auto flex max-w-7xl items-center justify-between">
          <div className="flex flex-wrap items-center gap-3 sm:gap-6 text-[11px]">
            ...
            <span className="hidden sm:inline text-neutral-300 font-d1-body">
      ...
      <header className="border-b border-neutral-300 bg-white relative">
        ...
        <div className="mx-auto max-w-7xl px-4 py-6 sm:px-8 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-4 text-center md:text-left">
            <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded bg-[#0d1b2a] text-amber-400 shadow-md border border-amber-500/40">
              <BookOpen className="h-9 w-9" />
            </div>
            <div>
              <div className="flex items-center justify-center md:justify-start gap-2">
                <span className="rounded bg-amber-100 px-2 py-0.5 font-d1-meta text-[10px] font-bold text-amber-900 uppercase tracking-widest border border-amber-300">
                  {settings.abbreviation}
                </span>
                <span className="text-xs font-semibold text-emerald-800 uppercase tracking-wider font-d1-body">
                  Peer-Reviewed & Open Access
                </span>
              </div>
              <h1
                onClick={() => onNavigate('home')}
                className="cursor-pointer font-d1-heading text-2xl sm:text-3xl font-bold tracking-tight text-[#0d1b2a] hover:text-amber-800 transition mt-1"
              >
          ...
          <div className="flex flex-wrap items-center gap-3 font-d1-body">
            <button
              onClick={() => onNavigate('submit')}
              className="inline-flex items-center gap-2 rounded bg-[#1b4332] px-5 py-2.5 text-xs font-bold text-white shadow-sm hover:bg-[#2d6a4f] transition border border-[#1b4332]"
            >
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded border border-neutral-300 bg-white px-4 py-2.5 text-xs font-semibold text-[#0d1b2a] hover:bg-neutral-50 transition"
            >
        ...
        <div className="border-t border-neutral-200 bg-[#0d1b2a] text-white font-d1-body">
          <div className="mx-auto flex max-w-7xl items-center justify-between px-4 sm:px-8">
            <nav className="hidden lg:flex items-center gap-1 text-xs font-semibold">
              <button
                onClick={() => onNavigate('home')}
                className={`px-3.5 py-3 hover:bg-neutral-800 transition ${
              ...
              <div className="relative group">
                <button
                  ...
                  className="px-3.5 py-3 hover:bg-neutral-800 transition flex items-center gap-1 text-neutral-200"
                >
                  <span>About</span>
                  <ChevronDown className="h-3 w-3 opacity-70" />
                </button>
                <div className="absolute left-0 top-full hidden group-hover:block w-56 border border-neutral-700 bg-[#0d1b2a] p-2 shadow-xl z-50">
                  <button
                    onClick={() => onNavigate('about')}
              ...
              <div className="relative group">
                ...
                <div className="absolute left-0 top-full hidden group-hover:block w-56 border border-neutral-700 bg-[#0d1b2a] p-2 shadow-xl z-50">
                  ...
                  <button
                    onClick={() => onNavigate('submit')}
                    className="w-full text-left px-3 py-1.5 text-xs text-amber-300 font-bold hover:bg-neutral-800"
                  >
                    Submit Manuscript
                  </button>
                </div>
            ...
            <div className="flex lg:hidden items-center justify-between w-full py-2.5">
              <span className="font-d1-heading font-bold text-sm text-amber-400">
                Menu
              </span>
              <button
            ...
            <div className="lg:hidden border-t border-neutral-800 bg-[#0d1b2a] px-4 py-4 space-y-2 text-xs">
              {[
                ...
                <button
                  ...
                  className="block w-full text-left px-3 py-2 text-neutral-200 hover:bg-neutral-800"
                >
                  {link.label}
                </button>
              ))}
      ...
      <footer className="border-t border-neutral-300 bg-[#0d1b2a] text-neutral-300 pt-12 pb-8 text-xs font-d1-body">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pb-10 border-b border-neutral-800">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                ...
                <h4 className="font-d1-heading font-bold text-white text-sm">
                  {settings.journalName}
                </h4>
              </div>
              ...
              <div className="font-d1-meta text-[11px] text-neutral-400 space-y-0.5">
            ...
            <div className="space-y-2">
              <h5 className="font-d1-heading font-bold text-white text-xs uppercase tracking-wider text-amber-400">
                Journal Information
              </h5>
