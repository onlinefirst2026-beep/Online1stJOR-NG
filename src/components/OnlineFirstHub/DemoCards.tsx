  ...
  const concepts = [
    ...
    },
    {
      ...
      features: [
        ...
        'Distinctive Royal Cobalt (#2a369c) & Periwinkle (#b3bcf2) scholarly palette',
        'Clean typography with Warm Tangerine (#e86b31) & Rust (#c04f17) accents',
      ],
      thumbnailComponent: <Demo3Thumbnail />,
      accentColor: 'border-[#2a369c]/60 hover:border-[#b3bcf2]',
      glowColor: 'from-[#2a369c]/20 to-[#14263D]/5',
      primaryBtnColor: 'bg-gradient-to-r from-[#2a369c] via-[#1f2979] to-[#c04f17] text-white font-bold hover:shadow-[0_0_15px_rgba(42,54,156,0.4)]',
      badgeStyle: 'bg-[#2a369c] text-[#b3bcf2] border-[#b3bcf2]/40',
