        ...
        <div className="flex-1 overflow-y-auto p-6 sm:p-8 space-y-6 font-inter">
          {submitted ? (
            <div className="space-y-5 text-center py-4">
              ...
              <h4 className="font-heading text-2xl font-bold text-[#F5FAFF]">
                Direction Selection Recorded!
              </h4>
              <p className="text-sm sm:text-base text-[#B7C6D8] max-w-md mx-auto leading-relaxed">
              ...
              <div className="rounded-2xl bg-[#0E1A2B] p-4 text-left font-mono-clean text-xs sm:text-sm text-[#7BE7FF] border border-[#223753] shadow-inner">
              ...
              <div className="flex flex-wrap justify-center gap-3 pt-2">
                ...
                <button
                  onClick={onClose}
                  className="rounded-xl bg-gradient-to-r from-[#35D6FF] via-[#56E0FF] to-[#3182CE] px-6 py-3 text-xs sm:text-sm font-bold text-[#0A121E] hover:shadow-[0_0_15px_rgba(53,214,255,0.4)] transition cursor-pointer min-h-[44px]"
                >
                  Close & Return
                </button>
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2.5">
                <label className="block text-xs sm:text-sm font-mono-clean font-bold uppercase tracking-wider text-[#7BE7FF]">
                  ...
                  {[
                    ...
                    >
                      <input
                        ...
                        className="text-[#35D6FF] focus:ring-[#35D6FF] h-4 w-4"
                      />
                      <span>{opt.label}</span>
                    </label>
                  ))}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  <label className="block text-xs font-mono-clean font-bold uppercase text-[#B7C6D8]">
                    Contact Person / Role
                  </label>
                  <input
                    type="text"
                    ...
                    required
                    className="w-full rounded-xl border border-[#223753] bg-[#0E1A2B] px-3.5 py-2.5 text-xs sm:text-sm text-[#F5FAFF] focus:border-[#35D6FF] focus:outline-none min-h-[42px]"
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full rounded-xl border border-[#223753] bg-[#0E1A2B] p-3 text-xs sm:text-sm text-[#F5FAFF] focus:border-[#35D6FF] focus:outline-none resize-none"
              ...
              <div className="rounded-xl border border-[#35D6FF]/30 bg-[#0E1A2B]/80 p-3.5 text-xs sm:text-sm text-[#B7C6D8] flex items-center justify-between">
                <span>Decision target: <strong className="text-[#35D6FF] font-semibold">{DECISION_DEADLINE}</strong></span>
                <span className="text-xs text-[#7BE7FF] font-mono-clean">OnlineFirst Studio Systems</span>
              </div>
              ...
              <div className="flex justify-end gap-3 pt-2">
                <button
                  type="button"
                  onClick={onClose}
                  className="rounded-xl px-5 py-3 text-xs sm:text-sm font-semibold text-[#B7C6D8] hover:text-white transition cursor-pointer min-h-[44px]"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-[#35D6FF] via-[#56E0FF] to-[#3182CE] px-7 py-3 text-xs sm:text-sm font-bold text-[#0A121E] hover:shadow-[0_0_20px_rgba(53,214,255,0.4)] transition cursor-pointer min-h-[44px]"
                >
